...
public class NeoforgeWindowAccessor {
  ...
  public static void closeForgeEarlyWindow() {
    try {
      ...
      ScheduledFuture<LoadingScreenRenderer> rendererFuture = mockScheduler.schedule(() -> {
      ...
      Class<?> simpleBufferBuilderClass = Class.forName("net.neoforged.fml.earlydisplay.render.SimpleBufferBuilder");
  ...
  public static void recreateForgeFramebuffer(long window) throws NoSuchFieldException, IllegalAccessException, NoSuchMethodException, InvocationTargetException, InterruptedException, TimeoutException {
    ...
    loadingScreenRenderer = new LoadingScreenRenderer(mockScheduler, StableFPS.window, theme, themePath, "?", "?");
