...
@Mod(StableFPS.MOD_ID)
public final class StableFPS {
	public StableFPS(FMLJavaModLoadingContext context) {}
	...
	public static final CountDownLatch setup_forgeWindowClosed = new CountDownLatch(1);
	public static final CountDownLatch setup_goRecreateFb = new CountDownLatch(1);
	public static final CountDownLatch setup_forgeFramebufferRecreated = new CountDownLatch(1);
	public static final CountDownLatch setup_windowListenersReady = new CountDownLatch(1);
