...
public class StableFPS implements ModInitializer {
	...
	public static class RenderThreadEvent {
		...
		public static final int RUN_ON_RENDER_THREAD_EVENT = 1;
		public int type;
	...
	public static class RunOnRenderThreadEvent extends RenderThreadEvent {
		public Runnable callback;
		RunOnRenderThreadEvent(Runnable callback) {
			super(RenderThreadEvent.RUN_ON_RENDER_THREAD_EVENT);
